 ...
 * Purpose: Read editable profile, CV, toolkit, and experience content from Supabase
 * Used by: Homepage and About page
 * Dependencies: Supabase browser client; profil_situs and pengalaman RLS policies
 * Public functions: getSiteProfile(), listExperience()
