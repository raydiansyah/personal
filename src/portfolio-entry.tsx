 ...
 * Used by: index.html #portfolio-data-root
...
const root = document.getElementById('portfolio-data-root');
if (root) createRoot(root).render(<QueryClientProvider client={new QueryClient()}><PortfolioDataIsland /></QueryClientProvider>);
